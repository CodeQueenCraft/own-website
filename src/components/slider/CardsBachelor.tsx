      ...
      <label htmlFor="slide-1" className="slider__item slider__item--1 card">
        <div className="slider__item-content">
          <p>
            ...
            dolor sit amet, consetetur sadipscing elLorem ipsum dolor sit amet,
            ...
            aliquyam erat, sed diam voluptua.", Loritr, sed diam nonumy eirmod
        ...
        <div className="slider__item-content">
          <div className="content">
            <p>
              ...
              sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore
              et dolore magna aliquyam erat, sed diam voluptua.", Lorem
            </p>
          </div>
        </div>
      </label>
        ...
        <div className="slider__item-content">
          <div className="content">
            <p>
              ...
              sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore
              et dolore magna aliquyam erat, sed diam voluptua.", Lorem ipsum
              dolor sit amet, consetetur sadipscing elLorem ipsum dolor sit
              amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor
            </p>
          </div>
        </div>
